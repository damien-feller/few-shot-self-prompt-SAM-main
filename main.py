...
def monte_carlo_sample_from_mask(heatmap, mask, ground_truth_mask, num_fg = 10, num_bg = 10):
    ...
    foreground_points = sample_points(foreground_indices, foreground_probs, n_points_foreground, alpha = 3)
...
def sample_points(indices, probabilities, n_points, fg=True, alpha=10.0):
    ...
    if fg:
        ...
        before = probabilities/probabilities.sum()
        plt.figure()
        ...
        after = probabilities_transformed/probabilities_transformed.sum()
        plt.figure()
